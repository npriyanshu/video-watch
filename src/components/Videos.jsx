...
const Videos = () => {
    ...
    const videosArr = [
        'https://player.vimeo.com/external/458882630.sd.mp4?s=0d3bb5821ca380988351b9534de76eb04fd48482&profile_id=164&oauth2_token_id=57447761',
  ...
  return (
    <Stack direction={['column','row']} h={'100vh'}>
        <VStack w={'full'}>
            ...
            <Text>
                This is a sample video for this project of mine.
            </Text>
            </VStack>
